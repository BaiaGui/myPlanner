...
export default function LandingPage({setPage}){
    return (
       <div className="w-sreen h-screen flex items-center flex-col bg-gradient-to-tr from-blue-900 to-indigo-950">
            <header className=" flex w-screen bg-gray-700/30 px-8 py-4 border-blue-200/10 border-b justify-between items-center">
                <p className="text-white text-2xl font-bold w-fit">myPlanner</p>
                <p className=" w-fit text-white/50">por BaiaGui</p>
            </header>
